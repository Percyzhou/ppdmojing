...
class_names3 <- lapply(1:6, function(x) paste0("ThirdParty_Info_Period", rep(x, 12), "_", 1:12))
class_names4 <- lapply(1:6, function(x) paste0("ThirdParty_Info_Period", rep(x, 5), "_", 13:17))
...
num_ThirdParty_1_list3 <- Map(f = function(x, y) statByTime(data = x, breaks = 1, Fun = c(mean, var), name = paste0("ThirdParty_Info_Period_", y), nameFun = c("mean", "var")), num_ThirdParty_list3, 1:6)
num_ThirdParty_2_list3 <- Map(f = function(x, y) statByTime(data = x, breaks = 2, Fun = c(mean, var), name = paste0("ThirdParty_Info_Period_", y), nameFun = c("mean", "var")), num_ThirdParty_list3, 1:6)
num_ThirdParty_4_list3 <- Map(f = function(x, y) statByTime(data = x, breaks = 4, Fun = c(mean, var), name = paste0("ThirdParty_Info_Period_", y), nameFun = c("mean", "var")), num_ThirdParty_list3, 1:6)
num_ThirdParty_all_list4 <- Map(f = function(x, y) statByTime(data = x, breaks = 1, Fun = c(mean, var), name = paste0("ThirdParty_Info_Period_", y), nameFun = c("mean", "var")), num_ThirdParty_list4, 1:6)
num_ThirdParty_withCategory <- do.call("cBind", c(num_ThirdParty_1_list3, num_ThirdParty_2_list3, num_ThirdParty_4_list3, num_ThirdParty_all_list4))
col_flag1 <- grepl("1_1", names(num_ThirdParty_withCategory))
col_flag2 <- grepl("4_4", names(num_ThirdParty_withCategory))
num_ThirdParty_withCategory_new <- num_ThirdParty_withCategory[, col_flag1 | col_flag2]
...
num_ThirdParty <- cBind(num_ThirdParty1, num_ThirdParty2, num_ThirdParty_withCategory, num_ThirdParty5, num_ThirdParty6)
# =============================================================================
# 读取WeblogInfo数据 ---------------------------------------------------------
